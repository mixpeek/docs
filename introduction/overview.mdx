...
It captures your unstructured object changes [consistent](/introduction/architecture), transforms them and inserts the structured output into your downstream database, so your application has fresh, structured data, always.
