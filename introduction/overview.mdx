...
<Note>[Comprehensive architecture guide](/introduction/architecture)</Note>

1. **Connect Datastores**: Integrate your existing datastores, such as S3 and MongoDB.
2. **Data Ingestion**: Add files (images, videos, audio, text, documents) to S3 or provide URLs.
3. **Indexing**: Use the powerful indexing API to process and structure your data.
4. **Access and Query**: Access the freshly structured data to build rich queries.
