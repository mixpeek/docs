...
description: "Guide to storing and retrieving embeddings"
icon: "database"
iconType: "solid"
---
...
First, index your video using the Mixpeek API. You can do this by sending a request to the [Index Video URL](/api-reference/index-videos/index-video-url) endpoint.
