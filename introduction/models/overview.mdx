...
| ------------------------------ | ------------------ | ---------- | ----------------------------------------------------------- |
| `multimodal-v1`                | Text, Image, Video | 1408       | Our most advanced model yet, supporting multiple modalities |
...
| `splade-v2`                    | Text               | N/A        | Full-text model for text-only embeddings                    |
