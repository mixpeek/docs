...
This means you never have to worry about [sync, replication, consistency, inference, etc](/introduction/architecture). You can focus on your query patterns and never deal with stale data.
...
<CardGroup cols={2}>
  <Card title="Amazon S3" icon="cloud" href="/introduction/integrations/s3">
    Source for data such as images, videos, and documents.
  </Card>
  <Card
    title="MongoDB"
    icon="database"
    href="/introduction/integrations/mongodb"
  >
  ...
  <Card
    title="Pinecone"
    icon="traffic-cone"
    href="/introduction/integrations/pinecone"
  >
    Vector database for building vector search applications.
  </Card>
  <Card title="Qdrant" icon="database" href="/introduction/integrations/qdrant">
...
<Steps>
  <Step title="Connect Your Source">
    ...
    <a href="/api-documentation/connections/create">Create Connection</a>
  </Step>
  <Step title="Configure the Mixpeek Pipeline">
    Define the extraction, generation, and embedding processes that will be
    applied to your data.
    <a href="/api-documentation/pipelines/create">Create Pipeline</a>
  </Step>
  ...
  <Step title="Activate the Integration">
    ...
    <a href="/api-documentation/pipelines/enable">Enable Pipeline</a>
