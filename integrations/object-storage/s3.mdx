...
6.  Search for and select the policy you created in Step 1 (e.g., `MixpeekS3ReadAccessPolicy`).
...
*   Attach the `MixpeekS3ReadAccessPolicy` created in Step 1 to this role.
...
### Step 3: Add S3 Connection in Mixpeek
...
3.  Enter the required details:
    ...
    *   **Authentication:**
        *   If using an IAM User: Provide the **Access Key ID** and **Secret Access Key** obtained in Step 2A.
        *   If using an IAM Role: Provide the **Role ARN** obtained in Step 2B.
