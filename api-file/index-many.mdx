...
<Note>
    S3 is currently the only supported directory. In order to use this API, you need to provision an IAM role in your AWS control plane. Follow [this tutorial](https://docs.aws.amazon.com/IAM/latest/UserGuide/id_credentials_access-keys.html) to do so.
</Note>
