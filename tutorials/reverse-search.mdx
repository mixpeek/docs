...
<AccordionGroup>
  ...
  <Accordion title="Scene-Level Video Search">
    Find specific moments in video archives by segmenting videos into scenes with `video_extractor`, accepting screenshot queries, and returning matching segments with timestamps.
  </Accordion>
