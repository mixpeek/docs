...
Semantic search goes beyond keyword matching to understand query intent and find conceptually relevant results. This tutorial shows you how to combine dense vector embeddings, sparse representations (BM25), and optional reranking for state-of-the-art retrieval accuracy.
...
```mermaid
graph TD
  Q[Query: 'best laptop for coding'] --> P[Parallel Search]
...
You can test new models without disrupting production by creating parallel collections, comparing results, and migrating seamlessly.
