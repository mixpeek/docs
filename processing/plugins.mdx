...
<Tip>
For comprehensive CLI documentation including all commands, options, and examples, see the [Mixpeek CLI Reference](/integrations/developer-tools/mixpeek-cli).
</Tip>
...
See the [Mixpeek CLI Reference](/integrations/developer-tools/mixpeek-cli) for detailed command options, environment variables, and troubleshooting.
...
<CardGroup cols={2}>
  <Card title="Mixpeek CLI" icon="terminal" href="/integrations/developer-tools/mixpeek-cli">
  ...
  <Card title="SDK Usage" icon="code" href="/integrations/developer-tools/sdk-usage">
