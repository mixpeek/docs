...
Pipelines are the backbone of Mixpeek's multimodal pipelines. It's where you describe how you want the engine to process your objects as they pass through in real-time.
