...
<Note>
  This page covers the key concepts and terminology used throughout the Mixpeek platform. Understanding these concepts will help you utilize the platform's offerings.
</Note>
...
| [Object](/management/objects) | Collections of related input files | Raw Data Files/Source Documents |
| [Blob](/management/blobs) | Individual raw files within Objects | Binary Data/Single File |
| [Collection](/management/collections) | Groups of processed documents with consistent schema | Table |
| [Document](/management/documents) | Structured outputs from feature extractors | Row |
...
<Steps>
  ...
  <Step title="Processing Flow (Ingestion Pipelines)">
    Objects from buckets are processed through ingestion pipelines. Feature extractors extract various features from the object's files, which are then organized into documents stored in collections.
  </Step>
