...
<CardGroup cols={2}>
  ...
  <Card title="Custom Processing Pipelines" icon="magnifying-glass">
  ...
  <Card title="Data Organization" icon="server">
...
<iframe
  width="600"
  height="310"
  src="https://d8ts56gtwtyh1.cloudfront.net/docs/warehouse/introduction.mp4"
  frameborder="0"
