...
<CardGroup cols={2}>
  ...
  <Card title="APPLY" icon="wand-magic-sparkles">
    ...
    **Stages**: json_transform, rag_prepare, external_web_search, api_call, sql_lookup, cross_compare, web_scrape, unwind, code_execution
  </Card>

  <Card title="ENRICH" icon="sparkles">
    Add knowledge to documents using AI models, taxonomies, or cross-collection joins.

    **Stages**: llm_enrich, taxonomy_enrich, document_enrich, agentic_enrich
  </Card>
</CardGroup>
