...
<CardGroup cols={2}>
  ...
  <Card title="APPLY" icon="wand-magic-sparkles">
    ...
    **Stages**: json_transform, rag_prepare, external_web_search, api_call, sql_lookup, llm_enrich, taxonomy_enrich, document_enrich, cross_compare, web_scrape
  </Card>
