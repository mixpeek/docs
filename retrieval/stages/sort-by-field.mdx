...
<Frame>
  <img src="/assets/retrievers/sort-by-field.svg" alt="Sort By Field stage showing attribute-based document ordering" />
</Frame>
...
- [Limit](/retrieval/stages/limit) - Reduce result count
- [Structured Filter](/retrieval/stages/structured-filter) - Filter before sorting
