...
```mermaid
graph LR
  V[Video Object] --> B[Batch Processing]
  B --> E1[Video Extractor]
  B --> E2[Audio Extractor]
  B --> E3[Text Extractor]
  E1 --> D1[Scene Documents]
  E2 --> D2[Transcript Documents]
  E3 --> D3[Caption Documents]
  D1 --> Q[Qdrant Collection]
  D2 --> Q
  D3 --> Q
  Q --> R[Retriever Pipeline]
```
